...
public class Tienda {
    HashMap<String,Alimento> alimentoHashMap;
    HashMap<String,Aparato> aparatoHashMap;
    HashMap<String,CuidadoPersonal> cuidadoPersonalHashMap;
    ...
    public HashMap<String, Alimento> getAlimentoHashMap() {
    ...
    public HashMap<String, Aparato> getAparatoHashMap() {
    ...
    public HashMap<String, CuidadoPersonal> getCuidadoPersonalHashMap() {
        return cuidadoPersonalHashMap;
    }
